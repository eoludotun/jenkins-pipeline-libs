...
def call(String lcovPath = 'artifacts/coverage', String lcovPath2 = 'coverage', String sonarScanDirs) {
  withCredentials([[$class: 'StringBinding',
    ...
    withSonarQubeEnv('SonarCloud') {
      ...
      def excludeFiles = '**/cli/stripes-core.js,**/docs/**,**/node_modules/**,**/examples/**,**/artifacts/**,**/ci/**,Jenkinsfile,**/LICENSE,**/*.css,**/*.md,**/*.json,**/tests/**,**/stories/*.js,**/test/**,**/.stories.js,**/resources/bigtest/interactors/**,**/resources/bigtest/network/**,**/*-test.js,**/*.test.js,**/*-spec.js,**/karma.conf.js,**/jest.config.js'
